...
\item GPU for local neural network training
\end{itemize}
\begin{center}
...
Every $n$ local network updates, all the nodes send weights
\begin{wrapfigure}{r}{0.45\textwidth}
  \vspace{-70pt}
  \begin{center}
    \includegraphics[width=1.0\textwidth]{allreduce.jpg}
  \end{center}
  \vspace{-20pt}
...
\begin{wrapfigure}{r}{0.45\textwidth}
  \vspace{-70pt}
  \begin{center}
    \includegraphics[width=1.0\textwidth]{butterfly.jpg}
  \end{center}
  \vspace{-20pt}
...
\begin{wrapfigure}{r}{0.45\textwidth}
  \vspace{-70pt}
  \begin{center}
    \includegraphics[width=1.0\textwidth]{ring.jpg}
  \end{center}
  \vspace{-20pt}
